...
export function calculate(button: ButtonCode, state: State) {
  ...
  function isOperatorButon(button: string): button is NumberCode {
    return button === "+" || button === "-";
  }

  function handleOperatorButton(button: NumberCode, state: State): State {
